...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (user) {
        ...
        if (user.username !== '' && user.password !== '') {
            this.http.post(baseUrl + '/login', user, { observe: 'response' }).subscribe(function (response) {
            ...
            function (err) { _this.messageEvent.emit("Username or Password is incorrect"); });
        }
        else {
            return new Error;
        }
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        // can be displayed
        this.authService.messageEvent.subscribe(function (res) {
