...
/* harmony import */ var _shop_products_products_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./shop/products/products.component */ "./src/app/shop/products/products.component.ts");
/* harmony import */ var _common_services_shop_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./common/services/shop.service */ "./src/app/common/services/shop.service.ts");
/* harmony import */ var _common_services_pager_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./common/services/pager.service */ "./src/app/common/services/pager.service.ts");
/* harmony import */ var _common_product_sort_pipe__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./common/product-sort.pipe */ "./src/app/common/product-sort.pipe.ts");
/* harmony import */ var _shop_checkout_checkout_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./shop/checkout/checkout.component */ "./src/app/shop/checkout/checkout.component.ts");
/* harmony import */ var _shop_account_account_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./shop/account/account.component */ "./src/app/shop/account/account.component.ts");
...
/* harmony import */ var _register_returns_returns_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./register/returns/returns.component */ "./src/app/register/returns/returns.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _shop_products_products_component__WEBPACK_IMPORTED_MODULE_14__["ProductsComponent"],
                _common_product_sort_pipe__WEBPACK_IMPORTED_MODULE_17__["ProductSortPipe"],
                //    CustomerComponent,
                _shop_checkout_checkout_component__WEBPACK_IMPORTED_MODULE_18__["CheckoutComponent"],
                _shop_account_account_component__WEBPACK_IMPORTED_MODULE_19__["AccountComponent"],
                _register_register_component__WEBPACK_IMPORTED_MODULE_20__["RegisterComponent"],
                _register_returns_returns_component__WEBPACK_IMPORTED_MODULE_21__["ReturnsComponent"]
            ],
            imports: [
    ...
    ProductSortPipe.prototype.transform = function (input) {
        if (input) {
            return input.sort(function (a, b) {
                var an1 = a.productrName.toLowerCase();
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (user) {
        ...
        if (user.username !== '' && user.password !== '') {
            return this.http.post(baseUrl + '/login', user, { observe: 'response' }).subscribe(function (response) {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.authService.login(this.form.value)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
...
var ReturnsComponent = /** @class */ (function () {
    function ReturnsComponent(shopService, pagerService, fb) {
        this.shopService = shopService;
...
module.exports = "#cart .p1[data-count]:after{\r\nposition:absolute;\r\nright:10%;\r\ntop:8%;\r\ncontent: attr(data-count);\r\nfont-size:40%;\r\npadding:.2em;\r\nborder-radius:10px;\r\nline-height:1em;\r\ncolor: white;\r\nbackground:#6394F8;\r\ntext-align:center;\r\nmin-width: 1em;\r\n}\r\n\r\n#cart .p3:hover{\r\ncolor: gray;  \r\n}\r\n\r\n#cart {\r\ncursor: pointer;\r\n}\r\n\r\n#header-color{\r\n    background-color: black;\r\n    color: white;\r\n    /* color: black; */\r\n}\r\n\r\n/* Hide scrollbar for Chrome, Safari and Opera */\r\n\r\n.menuBar::-webkit-scrollbar {\r\n    display: none;\r\n  }\r\n\r\n/* Hide scrollbar for IE, Edge and Firefox */\r\n\r\n.menuBar {\r\n    -ms-overflow-style: none;  /* IE and Edge */\r\n    scrollbar-width: none;  /* Firefox */\r\n  }\r\n/*# sourceMappingURL=data:application/json;base64, */"
